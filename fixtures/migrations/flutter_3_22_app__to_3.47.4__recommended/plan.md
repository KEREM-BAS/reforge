...
- note: The Kotlin Gradle plugin stays declared in android/settings.gradle, so Flutter can apply it.
- note: android.builtInKotlin stays false. Enabling built-in Kotlin needs Flutter 3.47 or later and plugins that support it.
