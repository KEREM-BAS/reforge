...
- ANDROID_JCENTER: The readable Android build scripts do not declare jcenter(); android/app/build.gradle could not be parsed reliably (see PROJECT_FILE_UNREADABLE).
