...
- ANDROID_COMPILE_SDK: compileSdk uses flutter.compileSdkVersion (36 in Flutter 3.44.0).
- ANDROID_APP_KOTLIN_PLUGIN: Flutter 3.44.0 only warns about apps applying the Kotlin Gradle plugin with Android Gradle Plugin 9 or later; this project uses 7.1.2.
...
- ANDROID_GRADLE_JVM_ARGS: Recommended but not required for Flutter 3.44.0: Update org.gradle.jvmargs to the value generated by Flutter 3.44.0.
- ANDROID_JETIFIER: Recommended but not required for Flutter 3.44.0: Remove android.enableJetifier=true from android/gradle.properties.
